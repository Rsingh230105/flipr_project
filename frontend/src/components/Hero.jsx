...
export default function Hero() {
  return (
    <section className="bg-gradient-to-b from-blue-600 to-indigo-700 text-white">
      <div className="container mx-auto px-4 py-16 md:py-20 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4">
            <a href="#contact" className="w-full sm:w-auto text-center px-5 py-3 bg-white text-indigo-700 rounded font-medium">Contact Us</a>
            <Link to="#projects" className="w-full sm:w-auto text-center px-5 py-3 border border-white rounded font-medium">Our Work</Link>
          </div>
        </div>

        <div className="w-full md:w-96 bg-white text-gray-900 rounded-lg p-4 md:p-6 shadow-lg">
